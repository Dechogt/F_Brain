...
urlpatterns = [
    ...
    path('list/', views.gamer_list_view, name='gamer_list'), # URL pour la liste des gamers (classement)
    path('/create/', views.gamer_create_update_view, name='gamer_create_update'), # URL pour créer/mettre à jour un profil
